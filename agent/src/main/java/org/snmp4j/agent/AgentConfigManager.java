...
public class AgentConfigManager implements Runnable {
  ...
  protected void linkCounterListener() {
    ...
    //@TODO: Remove cast with SNMP4J 3.0:
    if (dispatcher instanceof MessageDispatcherImpl) {
      MessageDispatcherImpl messageDispatcher = (MessageDispatcherImpl)dispatcher;
      messageDispatcher.removeCounterListener(snmpMpdMib);
      messageDispatcher.addCounterListener(snmpMpdMib);
    }
